...
public class ShopOnlineDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
	    ...
	    {
		    Id = 2,
		    Name = "C urology - Skin Care Kit",
		    Description = "A kit provided by C urology, containing skin care products",
	    ...
	    {
		    Id = 3,
		    Name = "Coco-oil - Organic Coconut Oil",
		    Description = "A kit provided by Coco-oil, containing skin care products",
	    ...
	    modelBuilder.Entity<Product>().HasData(new Product
	    {
		    ...
		    Description = "Game boy - Provided by Nintendo",
	    ...
	    modelBuilder.Entity<Product>().HasData(new Product
	    {
		    ...
		    Description = "Colorful trainers - available in most sizes",
	    ...
	    {
		    Id = 23,
		    Name = "Birkenstock Handles",
		    Description = "Birkenstock Handles - available in most sizes",
